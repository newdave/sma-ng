...
## [3.2.0](https://github.com/newdave/sma-ng/compare/sma-ng-v3.1.0...sma-ng-v3.2.0) (2026-09-25)
...
* **converter:** add force-reencode to rebuild video instead of copying ([a739e27](https://github.com/newdave/sma-ng/commit/a739e273ae75e58dfe4bcdb0c79f2c6b3cb82de4))
* **daemon:** expose version and git commit on /health and /status ([14bd575](https://github.com/newdave/sma-ng/commit/14bd575a49a7d38751c7b10759130ce2b85c95a9))
* **daemon:** surface version in webui and CLI, add changelog docs page ([244d2f5](https://github.com/newdave/sma-ng/commit/244d2f589c2e10b6d28a2f2cc65a30b1fd951528))
...
* **deploy:** support multiple library paths per service instance via routes list ([50dcd3f](https://github.com/newdave/sma-ng/commit/50dcd3fc81c9a78ad49cc89158e28062f64afdb6))
...
* **docker:** upgrade FFmpeg to 8.1.2 ([2e26970](https://github.com/newdave/sma-ng/commit/2e26970971d1d6f395d852ee38f41a41c47a0d47))
* **log:** add thread + job context to all log formatters ([7a86b0c](https://github.com/newdave/sma-ng/commit/7a86b0c337ccdf9251c0c2bccf40ee0485b12ce4))
* **mediaprocessor:** log one-line source media summary at INFO ([b93442f](https://github.com/newdave/sma-ng/commit/b93442fa49e520198122d966580d49f0101a9599))
* **mediaprocessor:** rescue decode-side HW failures with sw-decode + hw-encode ([821f4b8](https://github.com/newdave/sma-ng/commit/821f4b842043e39efb9b8cc32650de6c51c6cb2f))
...
* **daemon:** pass --job-id to the manual.py subprocess so ffmpeg stderr is ingested ([997e7cd](https://github.com/newdave/sma-ng/commit/997e7cd90d2b2a6e5f083881a656183a077a2b4f))
...
* **docker:** pin nv-codec-headers to n13.0.19.0 ([81b4e23](https://github.com/newdave/sma-ng/commit/81b4e23d3edca9f0a188f50ec64771128f67028f))
* **docker:** ship operator docs and CHANGELOG.md in the image so /docs works ([95cb7c3](https://github.com/newdave/sma-ng/commit/95cb7c340e354f9cfb950e0fc38b35421b19db6b))
* **failures:** require bitmap+text context for image_subtitle_to_text diagnosis ([7f3dc61](https://github.com/newdave/sma-ng/commit/7f3dc615c8d87f5d499275f5b47f66b93f501358))
* **mediaprocessor:** also upgrade 8-bit profile to 10-bit for 10-bit output ([ff72386](https://github.com/newdave/sma-ng/commit/ff72386c36707643ba80401b587babe1bc981ba6))
* **mediaprocessor:** downgrade 10-bit profile to 8-bit sibling for 8-bit output ([5cbce46](https://github.com/newdave/sma-ng/commit/5cbce46d31ed77ce4f73d20b18ca12a1bf50da47))
* **mediaprocessor:** downmix 7.1 audio for encoders capped at 5.1 ([98b2beb](https://github.com/newdave/sma-ng/commit/98b2beb2127567e915142b9742a2a6f51f509d6a))
* **mediaprocessor:** only allow video, audio, and text-subtitle streams into output ([d20840c](https://github.com/newdave/sma-ng/commit/d20840cdeccab781d2f7ac66e701b494c6672fba))
* **mediaprocessor:** stop hw_alt tier duplicating -filter_hw_device ([3cb1921](https://github.com/newdave/sma-ng/commit/3cb1921af25067ef89a695fc8a052e5e029ba792))
* **mediaprocessor:** stop hw_alt tier duplicating the VAAPI device init ([8e0d265](https://github.com/newdave/sma-ng/commit/8e0d2656ad85f6902c909fb57f7b7dcc4072ec9b))
* **subtitles:** auto-detect sidecar encoding instead of dropping non-UTF-8 srt files ([bb25d77](https://github.com/newdave/sma-ng/commit/bb25d774b2b035609bb1fb6c5e43b05ba5115766))


### Documentation

* **configuration:** document converter.fallback-policy enum ([d031042](https://github.com/newdave/sma-ng/commit/d031042eea872d0f471ac8511c851d9a8db38dad))
* **configuration:** GOP tuning guidance for seeking and trick-play ([a5fe9af](https://github.com/newdave/sma-ng/commit/a5fe9afbf6aa2accec5bd27a6f6468864fa69f56))
...
* **webhook:** document profile and force flags in sma-webhook.sh usage ([2df5efc](https://github.com/newdave/sma-ng/commit/2df5efcdeaf4af667c6087aab7db4ae4702634df))
