...
VIDEO_CODEC_DISPLAY = {
    ...
    'av1': 'AV1', 'vp9': 'VP9', 'mpeg4': 'XviD',
    'msmpeg4v2': 'XviD', 'msmpeg4v3': 'XviD',
...
AUDIO_CHANNELS_DISPLAY = {
    1: '1.0', 2: '2.0', 3: '2.1', 6: '5.1', 7: '6.1', 8: '7.1',
}

QUALITY_MAP = {
    (7600, 99999): '8K', (3800, 7599): '4K', (1900, 3799): '1080p',
    (1260, 1899): '720p', (0, 1259): 'SD',
}
...
SOURCE_MAP = {
    ...
    'hdtv': 'HDTV', 'pdtv': 'PDTV', 'dsr': 'DSR',
    'dvdrip': 'DVDRip', 'dvd': 'DVD',
    'remux': 'Remux',
}

HDR_DISPLAY = {
    'smpte2084': 'HDR', 'arib-std-b67': 'HLG',
    'bt2020': 'HDR10',
}
