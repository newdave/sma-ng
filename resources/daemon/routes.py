...
def _get_routes():
  return {
    ...
    "/metrics": lambda handler, path, query: handler._get_metrics_prom(path, query),
    "/dashboard/metrics": lambda handler, path, query: handler._get_metrics_page(path, query),
